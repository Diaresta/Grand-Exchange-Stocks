    ...
    <div id='terms-container'>
      <section>
        ...
        <ol>
          ...
          <li>
            <a href='#links-to-other-sites'>Links to Other Websites</a>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ge.teller.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to ge.teller, accessible from{' '}
              <a
                href='ge-teller.com'
